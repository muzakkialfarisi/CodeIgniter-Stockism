						...
						<div class="card-body">
							...
							<h1 class="display-5 mt-1 mb-3">
								<?php 
									...
									echo $this->db->query("SELECT * FROM masproduct where email_tenant = '$email_tenant'")->num_rows();
                                ?>
							</h1>
							<div class="mb-0">
					...
					<div class="card">
						<div class="card-body">
							...
							<h1 class="display-5 mt-1 mb-3">
								<?php 
									$email_tenant = $this->session->userdata['logged_in']['email_tenant'];
									echo $this->db->query("SELECT * FROM masemployee where email_tenant = '$email_tenant'")->num_rows();
                                ?>
							</h1>
							<div class="mb-0">
					...
					<div class="card">
						<div class="card-body">
							...
							<h1 class="display-5 mt-1 mb-3">
								<?php 
									$email_tenant = $this->session->userdata['logged_in']['email_tenant'];
									echo $this->db->query("SELECT * FROM incpurchaseorder where email_tenant = '$email_tenant'")->num_rows();
                                ?>
							</h1>
							<div class="mb-0">
					...
					<div class="card">
						<div class="card-body">
							...
							<h1 class="display-5 mt-1 mb-3">
								<?php 
									$email_tenant = $this->session->userdata['logged_in']['email_tenant'];
									echo $this->db->query("SELECT * FROM outsalesorder where email_tenant = '$email_tenant'")->num_rows();
                                ?>
							</h1>
							<div class="mb-0">
								<!-- <span class="text-success"> <i class="mdi mdi-arrow-bottom-right"></i> 8.35% </span>
