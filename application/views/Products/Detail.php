        ...
        <div class="card bg-transparent">
            <div class="tab m-0">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#tab-2" data-bs-toggle="tab" role="tab" aria-selected="false">Sales Orders</a></li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-2" role="tabpanel">
                        <?php $this->load->view("Products/DetailSalesOrder.php") ?>
                    </div>
