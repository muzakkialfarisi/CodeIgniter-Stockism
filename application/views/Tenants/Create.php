<div class="modal fade" id="ModalCreate" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            <form action="<?= site_url('Tenants/CreatePost') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body m-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 text-center">
                            <img src="<?= base_url(); ?>/assets/img/tenant/default-tenant.png" class="img-thumbnail picture_preview" height="60" width="60" asp-append-version="true"/>
                        </div>
                    </div>
