...
-- ----------------------------
INSERT INTO `incpurchaseorder` VALUES (51, '220602-074603', '2022-06-02 12:45:00', 'a@a', '220511-191240', 0, 'Done', 'Paid', 4, 0, '0000001', '0000-00-00 00:00:00');
...
-- ----------------------------
INSERT INTO `incpurchaseorderproduct` VALUES (68, 51, '2022-06-02 12:45:00', '220512-035448', 19, 100, 100, 6800000, 680000000, '0000-00-00 00:00:00', '');
INSERT INTO `incpurchaseorderproduct` VALUES (69, 51, '2022-06-02 12:45:00', '220513-083802', 21, 100, 100, 200000, 20000000, '0000-00-00 00:00:00', '');
INSERT INTO `incpurchaseorderproduct` VALUES (70, 51, '2022-06-02 12:45:00', '220513-081836', 20, 100, 100, 400000, 40000000, '0000-00-00 00:00:00', '');
...
INSERT INTO `masmarketplace` VALUES (3, 'Shopee');
INSERT INTO `masmarketplace` VALUES (4, 'Lazada');
INSERT INTO `masmarketplace` VALUES (5, 'Blibli');
INSERT INTO `masmarketplace` VALUES (6, 'Bhineka');
INSERT INTO `masmarketplace` VALUES (7, 'Orami');
INSERT INTO `masmarketplace` VALUES (8, 'JD.ID');
INSERT INTO `masmarketplace` VALUES (9, 'Zalora');
INSERT INTO `masmarketplace` VALUES (10, 'Sociolla');
...
-- ----------------------------
INSERT INTO `maspiutang` VALUES (14, 9400000, 9399000, 'Debt', '220511-191240', '2022-06-30 13:06:00', '0000-00-00 00:00:00');
...
CREATE TABLE `maspiutangangsuran`  (
  ...
  INDEX `id_sopiutang`(`id_so`) USING BTREE,
  CONSTRAINT `id_sopiutang` FOREIGN KEY (`id_so`) REFERENCES `maspiutang` (`id_so`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of maspiutangangsuran
-- ----------------------------
INSERT INTO `maspiutangangsuran` VALUES (7, 14, '2022-06-02 13:21:00', 1000);
INSERT INTO `maspiutangangsuran` VALUES (8, 14, '2022-06-02 13:27:00', 2000);
INSERT INTO `maspiutangangsuran` VALUES (9, 14, '2022-06-02 13:27:00', 9396000);
...
-- ----------------------------
INSERT INTO `masproduct` VALUES (19, '220512-035448', '61375487-DCA0-4E76-A4D7-11A0DDE79399', '61375487-DCA0-4E76-A4D7-11A0DDE79399.png', 'Aspire 5 Slim (A514-54)', 88, 6800000, 8900000, 0, 0, 0, 0, '', 3, 'Active', 8, 9, '220511-191240', 'default-product.png');
INSERT INTO `masproduct` VALUES (20, '220513-081836', '1D430E8D-796C-4D0D-B6A1-E5AB097B6CA9', '1D430E8D-796C-4D0D-B6A1-E5AB097B6CA9.png', 'Box RAM Laptop Corsair DDR4 4gb 2400MHz Sodim', 87, 400000, 500000, 0, 0, 0, 0, '', 3, 'Active', 8, 9, '220511-191240', '1D430E8D-796C-4D0D-B6A1-E5AB097B6CA9.jpg');
INSERT INTO `masproduct` VALUES (21, '220513-083802', 'D17B1636-04D9-44E6-8524-84810FE16379', 'D17B1636-04D9-44E6-8524-84810FE16379.png', 'Geoff Max Sandals Anniver 9 0 Black Pink', 87, 200000, 130000, 0, 0, 0, 0, '', 3, 'Active', 7, 10, '220511-191240', 'D17B1636-04D9-44E6-8524-84810FE16379.png');
...
INSERT INTO `masproduct` VALUES (23, '220514-062158', 'EBA04A27-AD33-4B5D-A744-41883031AC3F', 'EBA04A27-AD33-4B5D-A744-41883031AC3F.png', 'as', 0, 1000, 1500, 0, 0, 0, 0, '', 3, 'Active', 7, 7, '220511-191240', 'default-product.png');
...
-- Records of mastoko
-- ----------------------------
INSERT INTO `mastoko` VALUES (5, 'Store 1', 0, 0, 'default-store.png', 1, '220511-191240', 'active');
...
-- ----------------------------
INSERT INTO `outsalesorder` VALUES (14, '220602-080712', '2022-06-30 13:06:00', 'a@a', '220511-191240', 1, 5, 0, 'Done', '', 'Debt', '0000-00-00 00:00:00', 9, 1, 0);
...
CREATE TABLE `outsalesorderproduct`  (
  ...
  `selling_price` decimal(10, 0) NOT NULL,
  `subtotal` decimal(10, 0) NOT NULL,
  `date_created` datetime(0) NOT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id_soproduct`) USING BTREE,
  INDEX `FK_MasProductOutSalesOrderProduct`(`id_product`) USING BTREE,
  INDEX `FK_idsoproduct`(`id_so`) USING BTREE,
  ...
  CONSTRAINT `FK_idsoproduct` FOREIGN KEY (`id_so`) REFERENCES `outsalesorder` (`id_so`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 33 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of outsalesorderproduct
-- ----------------------------
INSERT INTO `outsalesorderproduct` VALUES (31, 14, 19, 1, 8900000, 8900000, '2022-06-03 13:29:38');
INSERT INTO `outsalesorderproduct` VALUES (32, 14, 20, 1, 500000, 500000, '2022-06-03 13:29:42');
...
INSERT INTO `secuser` VALUES ('stockism2022@gmail.com', '$2y$12$c4cd4a1f900f538b77e01un3qNM3mgZ5A.sZPfdawzeyCqwS0t2bC', '', 1, 'active', 1);
INSERT INTO `secuser` VALUES ('w@w', '$2y$12$3iNJnE6iL6MEmkQaHGmeXe60xWHs74Gui.nhTkJbBxxXX5AoMGMe.', 'db4dca38987364a80cee4c6d89248cf5', 0, 'active', 3);
